export const LANDING_ZONE_GRAPHS = process.env.LANDING_ZONE_GRAPHS || 'http://mu.semte.ch/graphs/landing-zone/op-consumer';
...
export const CREATOR = 'http://lblod.data.gift/services/contact-data-dispatcher-service';
